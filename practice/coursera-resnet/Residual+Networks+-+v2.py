...
print(x)
x_norm = keras.utils.normalize(x, axis=-1, order=1)
print(x_norm)


# In[2]:

np.eye(2, dtype=int)[[0,1,0,1]]
...
def identity_block(X, f, filters, stage, block):
    ...
    X = Conv2D(filters = F2, kernel_size = f, strides = (1,1), padding = 'same', name = conv_name_base + '2b', kernel_initializer = glorot_uniform(seed=0))(X)
